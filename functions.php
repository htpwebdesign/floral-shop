 ...
 */
function floral_shop_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'floral-shop' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'floral-shop' ),
...
add_action( 'widgets_init', 'floral_shop_widgets_init' );
